...
const vec4  light_color = vec4(0.78, 0.09, 0.09, 1.0); // r, g, b, a. the gradient light that is above (and on top) of the water
...
const float glow_strength = 20;                 //how strong the glow effect is
const float glow_threshold = .7;               //how bright the green channel needs to be to trigger a glow
const float glow_distance = .0001;             //size of the glow
const float overexpose = .2;                  //colors more than full bright bleed into other channels to make stuff whiter
