...
const vec4 light_color = vec4(1, 2.0, 2.0, 0.5); //r, g, b, a. the gradient light that is above (and on top) of the water
const float light_distance = 12;                //less = farther distance
const float glow_strength = 6;
...
const float light_strength = 3;
        ...
        float dy = abs((waterheight+10) - worldPos.y);
