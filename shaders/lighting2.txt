...
const float glow_strength = .5;
    ...
    void frag(){
        ...
        float l_0 = min(1.0, light0.z / noise(length(light0.xy - worldPos) + light0.z*.75));
        float l_1 = min(1.0, light1.z / noise(length(light1.xy - worldPos) + light1.z*.75));
        float l_2 = min(1.0, light2.z / noise(length(light2.xy - worldPos) + light2.z*.75));
        float l_3 = min(1.0, light3.z / noise(length(light3.xy - worldPos) + light3.z*.75));
        float l_4 = min(1.0, light4.z / noise(length(light4.xy - worldPos) + light4.z*.75));
        float l_5 = min(1.0, light5.z / noise(length(light5.xy - worldPos) + light5.z*.75));
        float l_6 = min(1.0, light6.z / noise(length(light6.xy - worldPos) + light6.z*.75));
        float l_7 = min(1.0, light7.z / noise(length(light7.xy - worldPos) + light7.z*.75));
